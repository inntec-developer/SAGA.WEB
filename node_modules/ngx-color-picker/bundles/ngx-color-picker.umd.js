...
var SliderDirective = (function () {
    ...
    SliderDirective.propDecorators = {
        "newValue": [{ type: core.Output, args: ['newValue',] },],
        "dragStart": [{ type: core.Output, args: ['dragStart',] },],
        "dragEnd": [{ type: core.Output, args: ['dragEnd',] },],
        "slider": [{ type: core.Input, args: ['slider',] },],
        "rgX": [{ type: core.Input, args: ['rgX',] },],
        "rgY": [{ type: core.Input, args: ['rgY',] },],
    };
...
var ColorPickerDirective = (function () {
    function ColorPickerDirective(injector, cfr, appRef, vcRef, elRef, service) {
        ...
        this.presetColorsChange = new core.EventEmitter(true);
    ...
    ColorPickerDirective.propDecorators = {
        "colorPicker": [{ type: core.Input, args: ['colorPicker',] },],
        "cpToggle": [{ type: core.Input, args: ['cpToggle',] },],
        "cpPosition": [{ type: core.Input, args: ['cpPosition',] },],
        "cpPositionOffset": [{ type: core.Input, args: ['cpPositionOffset',] },],
        "cpPositionRelativeToArrow": [{ type: core.Input, args: ['cpPositionRelativeToArrow',] },],
        "cpOutputFormat": [{ type: core.Input, args: ['cpOutputFormat',] },],
        "cpPresetLabel": [{ type: core.Input, args: ['cpPresetLabel',] },],
        "cpPresetEmptyMessage": [{ type: core.Input, args: ['cpPresetEmptyMessage',] },],
        "cpPresetEmptyMessageClass": [{ type: core.Input, args: ['cpPresetEmptyMessageClass',] },],
        "cpPresetColors": [{ type: core.Input, args: ['cpPresetColors',] },],
        "cpMaxPresetColorsLength": [{ type: core.Input, args: ['cpMaxPresetColorsLength',] },],
        "cpCancelButton": [{ type: core.Input, args: ['cpCancelButton',] },],
        "cpCancelButtonClass": [{ type: core.Input, args: ['cpCancelButtonClass',] },],
        "cpCancelButtonText": [{ type: core.Input, args: ['cpCancelButtonText',] },],
        "cpOKButton": [{ type: core.Input, args: ['cpOKButton',] },],
        "cpOKButtonClass": [{ type: core.Input, args: ['cpOKButtonClass',] },],
        "cpOKButtonText": [{ type: core.Input, args: ['cpOKButtonText',] },],
        "cpAddColorButton": [{ type: core.Input, args: ['cpAddColorButton',] },],
        "cpAddColorButtonClass": [{ type: core.Input, args: ['cpAddColorButtonClass',] },],
        "cpAddColorButtonText": [{ type: core.Input, args: ['cpAddColorButtonText',] },],
        "cpRemoveColorButtonClass": [{ type: core.Input, args: ['cpRemoveColorButtonClass',] },],
        "cpFallbackColor": [{ type: core.Input, args: ['cpFallbackColor',] },],
        "cpHeight": [{ type: core.Input, args: ['cpHeight',] },],
        "cpWidth": [{ type: core.Input, args: ['cpWidth',] },],
        "cpIgnoredElements": [{ type: core.Input, args: ['cpIgnoredElements',] },],
        "cpDialogDisplay": [{ type: core.Input, args: ['cpDialogDisplay',] },],
        "cpSaveClickOutside": [{ type: core.Input, args: ['cpSaveClickOutside',] },],
        "cpAlphaChannel": [{ type: core.Input, args: ['cpAlphaChannel',] },],
        "cpUseRootViewContainer": [{ type: core.Input, args: ['cpUseRootViewContainer',] },],
        "cpInputChange": [{ type: core.Output, args: ['cpInputChange',] },],
        "cpToggleChange": [{ type: core.Output, args: ['cpToggleChange',] },],
        "cpSliderChange": [{ type: core.Output, args: ['cpSliderChange',] },],
        "cpSliderDragEnd": [{ type: core.Output, args: ['cpSliderDragEnd',] },],
        "cpSliderDragStart": [{ type: core.Output, args: ['cpSliderDragStart',] },],
        "colorPickerCancel": [{ type: core.Output, args: ['colorPickerCancel',] },],
        "colorPickerSelect": [{ type: core.Output, args: ['colorPickerSelect',] },],
        "colorPickerChange": [{ type: core.Output, args: ['colorPickerChange',] },],
        "presetColorsChange": [{ type: core.Output, args: ['cpPresetColorsChange',] },],
    };
